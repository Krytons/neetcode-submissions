def swapPosition(array, origin, destination):
    print("Origine: {}, Destinazione: {}".format(origin, destination))
    ...
    def kClosest(self, points: List[List[int]], k: int) -> List[List[int]]:
        ...
        while continueCondition:
            ...
            for index in range(start, stop + 1):
                ...
                print("Valore pivot: {}, Valore corrente: {}".format(pivotValue, elementValue))
                if elementValue <=  pivotValue:
                    i += 1
                    print("Valore di i: {}. Indice corrente: {}".format(i, index))
                    if i != index:
            ...
            if i == k - 1 or i == k:
                ...
                stop = i - 1
                i = -1
                print("Riprendo da {} e finisco con {}".format(start, stop))
            print(points)
